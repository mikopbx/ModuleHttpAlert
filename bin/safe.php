...
use Modules\ModuleHttpAlert\Lib\HttpAlertConf;
require_once 'Globals.php';

$moduleEnable = PbxExtensionUtils::isEnabled('ModuleHttpAlert');
if(!$moduleEnable){
    exit(1);
}
$conf = new HttpAlertConf();
...
foreach ($workers as $workerData) {
    ...
    if (empty($WorkerPID)) {
        ...
        SystemMessages::sysLogMsg('ModuleHttpAlert_SAFE', "Service {$workerData['worker']} started.", LOG_NOTICE);
    }else{
